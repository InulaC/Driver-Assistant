...
class TelemetryRecord:
    ...
    def from_metrics(
        ...
        return cls(
            ...
            capture_latency_ms=frame_metrics.capture_latency_ms,
            lane_latency_ms=frame_metrics.lane_latency_ms,
            yolo_latency_ms=frame_metrics.yolo_latency_ms,
            yolo_skipped=frame_metrics.yolo_skipped,
            decision_latency_ms=frame_metrics.decision_latency_ms,
            alert_type=frame_metrics.alert_type,
            alert_latency_ms=frame_metrics.alert_latency_ms,
            cpu_temperature_c=system_metrics.cpu_temperature_c,
